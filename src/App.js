        ...
        <Grid>
          <Grid.Column width={6}>
            <Message icon color="green">
              ...
              <Message.Content>
                Below you will find any available google sheet which is shared with the service
                account email below. The Google Project listed below will need the google drive and
                google sheets apis enabled.
              </Message.Content>
            </Message>
            <Table>
              <Table.Body>
